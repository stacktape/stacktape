 ...
 * rendered type declarations. Produced by `apps/cli`'s `generate:llm-docs`, which is the single
...
/** Deterministic LLM documentation corpus. Produced by `apps/cli`'s `generate:llm-docs`. */
