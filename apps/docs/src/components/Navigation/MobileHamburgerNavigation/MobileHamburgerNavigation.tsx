...
export function MobileHamburgerNavigation({ allDocPages, pathname }: { allDocPages: DocPage[]; pathname?: string }) {
  ...
  return (
    <div className={clsx('hidden basis-full flex-col', isOpen ? 'max-[795px]:!flex' : 'max-[795px]:!hidden')}>
