...
// re-render through ~150 nav nodes.
...
/** The store plus the mount-time hydration hook only <ContentTree> is expected to call. */
type ExpansionStoreInternal = ExpansionStore & { hydrateOverrides: () => void };
