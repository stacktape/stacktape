...
<FeatureComparisonTable
  ...
  features={[
    ...
    { name: "Custom build support", values: { "Function packaging": "Pre-built zip, directory, or non-zip file", "Container packaging": "Dockerfile, prebuilt image, Nixpacks, Cloud Native Buildpacks" } }
  ]}
/>
...
<Tip>
You can run packaging without deploying using [`stacktape package`](/cli/package). This is useful for testing your build configuration or for CI pipelines that separate the build and deploy steps.
</Tip>
