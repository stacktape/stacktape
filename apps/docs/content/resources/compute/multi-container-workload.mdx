...
order: 34
seoTitle: 'Multi-Container Workload | Stacktape Docs'
seoDescription: 'Run multiple containers as a single ECS unit with Stacktape. Shared compute, per-container traffic routing, init containers, and horizontal auto-scaling on AWS Fargate.'
---
