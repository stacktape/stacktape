...
title: 'Email sender'
order: 5
seoTitle: 'Send Email with Amazon SES | Stacktape Docs'
seoDescription: 'Create or reuse a verified Amazon SES identity with scoped permissions, DKIM, suppression, and bounce and complaint events.'
---
...
<ApiReference definitionName="EmailSenderProps" />
