...
order: 75
seoTitle: 'AgentCore Code Interpreter – Sandboxed Code Execution | Stacktape'
seoDescription: 'Add sandboxed code execution to AI agents with Stacktape AgentCore Code Interpreter. Provision a managed AWS Bedrock AgentCore tool for data analysis, calculations, and charts.'
---
  ...
  tabs={[
    {
      label: 'TypeScript',
      lang: 'typescript',
      code: `import { defineConfig, AgentCoreCodeInterpreter } from 'stacktape';
...
<ApiReference definitionName="AgentCoreCodeInterpreterProps" />
