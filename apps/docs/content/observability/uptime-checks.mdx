...
title: 'Uptime Checks'
order: 101
seoTitle: 'Multi-Region Uptime Monitoring | Stacktape Docs'
seoDescription: 'Monitor endpoint availability from multiple AWS regions of your own account. Configure uptime checks in your stacktape config with assertions, evaluation thresholds, and alert notifications.'
---
