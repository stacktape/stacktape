...
<Info>
Resources configured with `logging.logClass: infrequent-access` do not feed Stacktape Issues because AWS does not support the required log subscription filters. Their logs remain available through bounded Logs Insights snapshots in the Console and CLI.
</Info>
