...
title: 'Incidents'
order: 95
seoTitle: 'Incident Detection, Triage & Recovery | Stacktape Docs'
seoDescription: 'Use Stacktape incidents to group related uptime, synthetic, alarm, runtime error, stack health, and certificate signals into one actionable lifecycle.'
---
