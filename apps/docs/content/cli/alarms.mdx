...
title: 'alarms'
order: 159
seoTitle: 'View CloudWatch Alarm States | stacktape alarms CLI | Stacktape Docs'
seoDescription: 'Check CloudWatch alarm states for your deployed Stacktape stack from the CLI. Filter by resource or state (OK, ALARM, INSUFFICIENT_DATA) and get JSON output for automation.'
---
