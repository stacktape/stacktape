...
seoDescription: 'Sync a local directory to an S3 bucket with Stacktape. Mirrors files, removes stale objects, invalidates CDN cache, and applies HTTP header presets.'
---
