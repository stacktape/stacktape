...
order: 166
seoTitle: 'container:exec CLI Command | Stacktape Docs'
seoDescription: 'Run a command inside a deployed container and get structured JSON output. Inspect files, check env vars, and run diagnostics on ECS workloads with the Stacktape CLI.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 8.2, hard blockers 2, advisory high 0, verifier medium 8'
---
