...
title: 'query:redis'
order: 170
seoTitle: 'query:redis CLI Command | Stacktape Docs'
seoDescription: 'Inspect deployed Redis clusters from the command line with stacktape query:redis. List keys, get values, check TTLs, and view server info — with automatic bastion tunneling for VPC clusters.'
---
