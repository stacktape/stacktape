...
title: 'synth'
order: 143
seoTitle: 'synth — Compile Config to CloudFormation | Stacktape CLI'
seoDescription: 'Use stacktape synth to compile your Stacktape configuration into a CloudFormation template without deploying. Inspect or process the generated template locally.'
---
...
Unlike [`deploy`](/cli/deploy), `synth` does not create or modify any stack resources. It does not require a previously deployed stack, and it does not require a Stacktape subscription.
