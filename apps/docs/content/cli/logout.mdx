...
seoDescription: 'Remove the stored Stacktape API key from your system with stacktape logout. Use when switching accounts, removing local credentials, or resetting keys.'
---
