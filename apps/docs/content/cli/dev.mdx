...
<CliCommandsApiReference command="dev" sortedArgs={[
  ...
  },
  {
    ...
    "longDescription": "<p>Disables automatic tunneling for Lambda functions. Stacktape creates tunnels (using bore.pub) so that AWS Lambda functions can reach your locally emulated databases. Use this flag if you don&#39;t need Lambda-to-local connectivity or if tunneling causes issues.</p>\n"
  },
  {
    "name": "outputFormat",
    "required": false,
