...
title: 'info:whoami'
order: 185
seoTitle: 'info:whoami CLI Command | Stacktape Docs'
seoDescription: 'Check your current Stacktape user, organization, connected AWS accounts, and project access. Verify your API key configuration with stacktape info:whoami.'
---
