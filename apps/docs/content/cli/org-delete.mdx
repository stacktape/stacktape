...
seoDescription: 'Remove your access to a Stacktape organization with the org:delete CLI command. Requires OWNER role, no other non-service users, and no active connected AWS accounts.'
---
...
<Warning>
This operation removes your access to the organization. Make sure you have another way to access anything you still need before continuing.
</Warning>
