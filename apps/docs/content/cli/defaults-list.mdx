...
seoDescription: 'View all system-wide Stacktape CLI defaults configured on your machine. Shows saved region, stage, AWS profile, and project name used as fallback arguments.'
---
