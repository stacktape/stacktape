...
<ConsoleScreenshot src="/static/screenshots/ai-config-generation.png" alt="AI config generation in the Stacktape Console — select a repository and branch, then review the generated config" caption="Select a repository and branch to start AI config generation for your codebase." />
...
<ConsoleScreenshot src="/static/screenshots/config-editor.png" alt="The Stacktape Console config editor" caption="Select a saved template and edit config content in the Console config editor." />
...
<PreviousNext right={{ title: 'Use the Dev Mode', url: '/getting-started/use-the-dev-mode' }} />