...
<PreviousNext left={{ title: 'Configure Your Stack', url: '/getting-started/configure-your-stack' }} right={{ title: 'Deploy Your First Stage', url: '/getting-started/deploy-your-first-stage' }} />