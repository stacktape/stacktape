...
<FlowDiagram steps={[
  ...
  { title: "Event matching", description: "The handler calls getActionsToPerform to determine deployment and deletion actions for the incoming GitHub event. A single event can yield multiple actions." },
