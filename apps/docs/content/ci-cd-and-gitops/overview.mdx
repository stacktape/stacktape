...
seoDescription: 'Automate Stacktape deployments with GitOps push-to-deploy, custom CI/CD pipelines, or self-hosted GitHub Actions runners. Compare options and choose the right path.'
---
...
<FeatureComparisonTable
  ...
  features={[
    ...
    { name: "Where the build runs", values: { "GitOps (Console)": "Dedicated EC2 runner in your AWS account", "Custom CI/CD": "Your CI provider's runners", "Self-hosted GitHub Actions runners": "EC2 runner in your AWS account" } },
