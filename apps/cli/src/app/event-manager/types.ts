...
export type EventLogEntryType = 'START' | 'UPDATE' | 'FINISH';
...
export type EventLogEntry = import('./event-log').EventLogEntry;
export type FormattedEventData = import('./event-log').FormattedEventData;
export type ChildEventLogEntry = import('./event-log').ChildEventLogEntry;

export type EventManagerProgressEvent = {
...
export type CleanupHookFunction = (input?: { success: boolean; interrupted: boolean; err?: Error }) => any;
