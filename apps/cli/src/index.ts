...
const commandUi: Record<StacktapeCommand, CommandUi> = {
  ...
  'alarms:export': { ui: 'none' },
  'info:whoami': { ui: 'none' },
  'ai:connect': { ui: 'none' },
  'ai:disconnect': { ui: 'none' },
  ...
  'secret:get': { ui: 'none' },
  incidents: { ui: 'none' },
  'incidents:show': { ui: 'none' },
  'incidents:watch': { ui: 'none' },
  'incidents:ack': { ui: 'none' },
  'incidents:resolve': { ui: 'none' },
  'issues:list': { ui: 'none' },
...
const commandLoaders = {
  ...
  'alarms:export': async () => (await import('./commands/alarms-export')).commandAlarmsExport,
  ...
  'ai:connect': async () => (await import('./commands/ai-connect')).commandAiConnect,
  'ai:disconnect': async () => (await import('./commands/ai-disconnect')).commandAiDisconnect,
  'info:operations': async () => (await import('./commands/info-operations')).commandInfoOperations,
  incidents: async () => (await import('./commands/incidents-list')).commandIncidentsList,
  'incidents:show': async () => (await import('./commands/incidents-show')).commandIncidentsShow,
  'incidents:watch': async () => (await import('./commands/incidents-watch')).commandIncidentsWatch,
  'incidents:ack': async () => (await import('./commands/incidents-ack')).commandIncidentsAck,
  'incidents:resolve': async () => (await import('./commands/incidents-resolve')).commandIncidentsResolve,
