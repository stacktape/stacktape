...
export type StageRestrictionGuardrail = {
...
export type RegionRestrictionGuardrail = {
...
export type CommandRestrictionGuardrail = {
...
export type ResourceTypeRestrictionGuardrail = {
...
export type RequireVpcDatabasesGuardrail = {
...
export type RequireDeletionProtectionGuardrail = {
...
export type RequireDeadLetterQueueGuardrail = {
...
export type FunctionMemoryLimitGuardrail = {
...
export type FunctionTimeoutLimitGuardrail = {
...
export type ContainerResourceLimitGuardrail = {
...
export type DatabaseEngineRestrictionGuardrail = {
...
export type DatabaseInstanceRestrictionGuardrail = {
...
export type RequireWafGuardrail = {
  type: 'require-waf';
  properties: {
    /**
...
export type RequireCustomDomainGuardrail = {
...
export type ResourceCountLimitGuardrail = {
