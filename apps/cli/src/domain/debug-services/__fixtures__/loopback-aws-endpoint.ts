...
export const startLoopbackAwsEndpoint = async () => {
  ...
  // The test preload turns configured endpoints off so nothing can reach real AWS; this fixture turns them back on
  // for its own process only, pointed at itself.
