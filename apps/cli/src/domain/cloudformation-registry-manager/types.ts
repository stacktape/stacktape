export type StpCfInfrastructureModuleType = 'atlasMongo' | 'upstashRedis' | 'ecsBlueGreen';

export type SupportedUpstashRedisV1ResourceType = 'Upstash::DatabasesV1::Database';

export type SupportedEcsBlueGreenV1ResourceType = 'Stacktape::ECSBlueGreenV1::Service';

export type SupportedMongoAtlasV1CfResourceType =
...
export type CloudformationPrivateTypeFile = { fileName: string };
