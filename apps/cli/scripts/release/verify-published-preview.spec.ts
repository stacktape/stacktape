...
import { assertInstalledCliVersion } from './verify-published-preview';

describe('published preview verification', () => {
  test('requires the launcher to report the exact immutable preview version', () => {
