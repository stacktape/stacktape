...
export const generateSchemas = async () => {
  ...
  // This generator owns validate-config-zod.ts, not the whole schemas directory.
  // Other schema variants are generated independently and must survive a config-schema refresh.
