...
// Source: aws-bedrock-flowversion.json

/** Definition of AWS::Bedrock::FlowVersion Resource Type */
export type AwsBedrockFlowversion = {
  /**
  ...
  Definition?: {
    ...
    Nodes?: ({
       ...
       */
      Name: string;
      Type: "Input" | "Output" | "KnowledgeBase" | "Condition" | "Lex" | "Prompt" | "LambdaFunction" | "Agent" | "Iterator" | "Collector" | "Storage" | "Retrieval" | "InlineCode" | "Loop" | "LoopInput" | "LoopController";
      Configuration?: {
