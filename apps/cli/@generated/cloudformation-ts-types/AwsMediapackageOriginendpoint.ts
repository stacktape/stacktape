...
// Source: aws-mediapackage-originendpoint.json
...
export type AwsMediapackageOriginendpoint = {
  ...
  HlsPackage?: {
     ...
     * greater than 0.
     * @enum ["NONE","SCTE35_ENHANCED","PASSTHROUGH","DATERANGE"]
     */
    AdMarkers?: "NONE" | "SCTE35_ENHANCED" | "PASSTHROUGH" | "DATERANGE";
    /**
     * A list of SCTE-35 message types that are treated as ad markers in the output.  If empty, no ad
     * markers are output.  Specify multiple items to create ad markers for all of the included message
     * types.
     */
  ...
  DashPackage?: {
     ...
     * @enum ["NONE","HBBTV_1_5","HYBRIDCAST","DVB_DASH_2014"]
     */
     ...
     * will be created where the Channel source contains SCTE-35 ad markers.
     */
    PeriodTriggers?: "ADS"[];
    /** When enabled, an I-Frame only stream will be included in the output. */
    IncludeIframeOnlyStream?: boolean;
     ...
     * When set to COMPACT, duplicate elements are combined and presented at the AdaptationSet level.
     * @enum ["FULL","COMPACT","DRM_TOP_LEVEL_COMPACT"]
     */
     ...
     * @enum ["HTTP-XSDATE","HTTP-ISO","HTTP-HEAD","NONE"]
     */
    UtcTiming?: "HTTP-XSDATE" | "HTTP-ISO" | "HTTP-HEAD" | "NONE";
    /**
     * Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO, HTTP-HEAD
     * or HTTP-XSDATE
     */
    UtcTimingUri?: string;
  };
