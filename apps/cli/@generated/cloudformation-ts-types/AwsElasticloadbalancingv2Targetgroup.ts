...
// Source: aws-elasticloadbalancingv2-targetgroup.json

/** Resource Type definition for AWS::ElasticLoadBalancingV2::TargetGroup */
export type AwsElasticloadbalancingv2Targetgroup = {
  ...
  Matcher?: {
    /**
     * You can specify values between 0 and 99. You can specify multiple values, or a range of values. The
     * default value is 12.
     */
    GrpcCode?: string;
    /**
     * For Application Load Balancers, you can specify values between 200 and 499, and the default value
     * is 200. You can specify multiple values or a range of values.
     */
    HttpCode?: string;
  };
  /**
  ...
  /**
   * The port that the target control agent uses to communicate the available capacity of targets to the
   * load balancer.
   */
