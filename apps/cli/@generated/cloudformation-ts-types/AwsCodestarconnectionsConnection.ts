...
// Source: aws-codestarconnections-connection.json

/**
 * Schema for AWS::CodeStarConnections::Connection resource which can be used to connect external
 * source providers with AWS CodePipeline
 */
export type AwsCodestarconnectionsConnection = {
  /**
