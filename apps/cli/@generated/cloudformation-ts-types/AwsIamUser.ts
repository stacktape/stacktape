...
// Source: aws-iam-user.json

/**
 * Creates a new IAM user for your AWS-account.
 * For information about quotas for the number of IAM users you can create, see [IAM and
...
export type AwsIamUser = {
   ...
   * AWS::IAM::User snippets, see [Declaring an User
   ...
   * of the following characters: _+=,.@-. The user name must be unique within the account. User names
   * are not distinguished by case. For example, you cannot create users named both "John" and "john".
   * If you don't specify a name, CFN generates a unique physical ID and uses that ID for the user
   * name.
   ...
   * through the console.
   * You can use the CLI, the AWS API, or the *Users* page in the IAM console to create a password for
   * any IAM user. Use
   * [ChangePassword](https://docs.aws.amazon.com/IAM/latest/APIReference/API_ChangePassword.html) to
   * update your own existing password in the *My Security Credentials* page in the console.
   * For more information about managing passwords, see [Managing
   * passwords](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_ManagingLogins.html) in the *User
   * Guide*.
   */
  LoginProfile?: {
