...
This page covers GitHub Actions jobs dispatched to the project's EC2 runner. The same runner also executes Console-managed GitOps deployments; see [Build runners](/ci-cd-and-gitops/build-runners) for its lifecycle, sizing, caching, and cost model.
