...
This is the local path: your assistant on your machine. For a hosted run instead, the Console can start Claude Code on the project's runner to investigate an incident or propose a fix as a draft pull request, funded by your organization's Anthropic API key or your own Claude subscription. See [AI assessment, investigation and fixes](/observability/incident-ai).
