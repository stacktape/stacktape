...
### Definition: `SvelteKitWebProps`

The complete property-level reference is included in `llms-api-reference.txt` and indexed under route `/config-reference/sveltekit-web` with definition name `SvelteKitWebProps`.
