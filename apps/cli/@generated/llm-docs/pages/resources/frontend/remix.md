...
### Definition: `RemixWebProps`

The complete property-level reference is included in `llms-api-reference.txt` and indexed under route `/config-reference/remix-web` with definition name `RemixWebProps`.
