...
```typescript
import type { AlarmEvaluation, ConsoleChannelIntegration, DiscordIntegration, EmailIntegration, LambdaDurationTrigger, LambdaErrorRateTrigger, MsTeamsIntegration, SlackAppIntegration, SlackIntegration, WebhookIntegration } from 'stacktape';
...
type LambdaAlarm = {
  ...
  notificationChannels?: Array<LambdaAlarmNotificationChannels>;
};
...
type LambdaAlarmNotificationChannels =
  | SlackIntegration
  | SlackAppIntegration
  | MsTeamsIntegration
  | EmailIntegration
...
- Required: yes
- Type: `lambda-error-rate | lambda-duration`
