...
```typescript
import type { AlarmEvaluation, ConsoleChannelIntegration, DiscordIntegration, EmailIntegration, LambdaDurationTrigger, LambdaErrorRateTrigger, MsTeamsIntegration, SlackIntegration, WebhookIntegration } from 'stacktape';
