...
export interface TransitVirtualInterfaceProperties {
  ...
  Vlan: Value<number>;
  AllocateTransitVirtualInterfaceRoleArn?: Value<string>;
  Tags?: List<ResourceTag>;
  Mtu?: Value<number>;
}
export default class TransitVirtualInterface extends ResourceBase<TransitVirtualInterfaceProperties> {
  static BgpPeer = BgpPeer;
  constructor(properties: TransitVirtualInterfaceProperties) {
    super('AWS::DirectConnect::TransitVirtualInterface', properties);
  }
}
