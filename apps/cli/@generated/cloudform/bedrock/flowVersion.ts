...
export interface FlowVersionProperties {
  Description?: Value<string>;
  FlowArn: Value<string>;
}
export default class FlowVersion extends ResourceBase<FlowVersionProperties> {
  ...
  constructor(properties: FlowVersionProperties) {
    super('AWS::Bedrock::FlowVersion', properties);
  }
}
