 ...
 * the wheel event before it reaches the renderer, so the deck keeps scrolling normally. Moving the
...
export default function DiagramIsland({ config, ariaLabel }: Props) {
  ...
  return (
    <div
      ref={host}
      className={active ? 'dk-diagram is-active' : 'dk-diagram'}
    ...
    >
      ...
      />
      <span className="dk-diagram__gate" aria-hidden="true">
