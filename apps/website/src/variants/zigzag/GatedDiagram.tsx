...
type Props = {
  /** The example configuration; a plain object that crosses the island boundary as JSON. */
 ...
 */
export function GatedDiagram({ config, ariaLabel }: Props) {
  ...
  return (
    <div
      ref={host}
      className={active ? 'zz-diagram is-active' : 'zz-diagram'}
    ...
    >
      ...
      />
      <span className="zz-diagram__gate" aria-hidden="true">
