/*
 * Everything the "stack" page says and shows.
 *
 * The page copy, the seven sections, the example project, the screens, the cover composite and the
...
export const RESOURCES = [
  ...
  },
  {
    ...
    short: 'Web app firewall',
    category: 'security',
    because: 'public web app',
    price: 0.9
  }
