...
#!/bin/sh
# Lightweight Stacktape installer for CI environments (without esbuild, pack, nixpacks, SSM binaries)
...
archive_source_url=https://github.com/stacktape/stacktape/releases/download/$version/linux-ci.tar.gz
