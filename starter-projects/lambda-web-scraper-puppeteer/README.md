...
- Navigate to the URL of <<mainApiGateway-url>>/scrape-links/<<url-of-the-website-to-scrape>> (without http://). The URL
  of your mainApiGateway is printed to the terminal as **mainApiGateway->url**.
