...
[fn:develop command](https://docs.stacktape.com/cli/commands/fn-develop/). For example, to develop and debug lambda function `kafkaProducer`, you can use

```bash
stp fn:develop --region <<your-region>> --stage <<stage>> --resourceName kafkaProducer
```
...
API Gateway receives requests and invokes our kafkaConsumer function.
