import type { ResourceOverrides, StpIamRoleStatement } from './shared';
...
export type SupportedHeaderPreset =
...
export interface BucketCdnConfiguration extends CdnConfiguration {
  /**
...
export interface LifecycleRuleBase {
  /**
...
export interface ExpirationProps extends LifecycleRuleBase {
  /**
...
export interface NonCurrentVersionExpirationProps extends LifecycleRuleBase {
  /**
...
export interface ClassTransitionProps extends LifecycleRuleBase {
  /**
...
export interface NonCurrentVersionClassTransitionProps extends LifecycleRuleBase {
  /**
...
export interface AbortIncompleteMultipartUploadProps extends LifecycleRuleBase {
  /**
...
export interface BucketPolicyIamRoleStatement extends StpIamRoleStatement {
  Principal: any;
}
