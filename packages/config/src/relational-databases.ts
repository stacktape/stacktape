import type { DevModeConfig, ResourceOverrides } from './shared';
import type { RelationalDatabaseAlarm } from './alarms';
...
export interface SharedEngineProperties {
  /**
...
export interface RdsEngineReadReplica extends RdsEnginePrimaryInstance {}


export interface RdsEngineProperties extends SharedEngineProperties {
  /**
...
export interface RelationalDatabaseLogging extends LogForwardingBase {
  /**
...
export interface AuroraServerlessEngineProperties extends Omit<SharedEngineProperties, 'version'> {
  /**
...
export interface AuroraServerlessV2EngineProperties extends SharedEngineProperties {
  /**
   * #### Name of the initial database.
 *
 * ---
...
export interface AuroraEngineProperties extends SharedEngineProperties {
  /**
   * #### Name of the initial database.
 *
 * ---
