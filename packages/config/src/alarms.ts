...
export interface ApplicationLoadBalancerAlarm extends AlarmDefinitionBase {
  trigger: ApplicationLoadBalancerAlarmTrigger;
}


export interface HttpApiGatewayAlarm extends AlarmDefinitionBase {
  trigger: HttpApiGatewayAlarmTrigger;
}


export interface LambdaAlarm extends AlarmDefinitionBase {
  trigger: LambdaAlarmTrigger;
}


export interface RelationalDatabaseAlarm extends AlarmDefinitionBase {
  trigger: RelationalDatabaseAlarmTrigger;
}


export interface SqsQueueAlarm extends AlarmDefinitionBase {
...
export interface SqsQueueReceivedMessagesCountTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface ApplicationLoadBalancerErrorRateTriggerProps extends TriggerWithCustomComparison {
  /**
...
export interface ApplicationLoadBalancerUnhealthyTargetsTriggerProps extends TriggerWithCustomComparison {
  /**
...
export interface HttpApiGatewayErrorRateTriggerProps extends TriggerWithCustomComparison {
  /**
   * #### Fires when 4xx/5xx error rate exceeds this percentage.
   *
   * ---
...
export interface HttpApiGatewayLatencyTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface LambdaErrorRateTriggerProps extends TriggerWithCustomComparison {
  /**
...
export interface LambdaDurationTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface RelationalDatabaseFreeMemoryTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface RelationalDatabaseReadLatencyTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface RelationalDatabaseFreeStorageTriggerProps extends TriggerWithCustomComparison, TriggerWithCustomStatFunction {
  /**
...
export interface TriggerWithCustomStatFunction {
  /**
...
export interface TriggerWithCustomComparison {
  /**
...
export type StatisticFunction = 'avg' | 'p90' | 'p95' | 'p99' | 'min' | 'max' | 'sum';
