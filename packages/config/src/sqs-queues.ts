...
import type { SqsQueueAlarm } from './alarms';
import type { EventBusIntegrationProps } from './events';
/**
...
export interface SqsQueueEventBusIntegrationProps extends EventBusIntegrationProps {
  /**
