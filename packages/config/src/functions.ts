...
export interface LambdaFunctionProps extends ResourceAccessProps {
  /**
...
export interface LambdaFunctionLogging extends LogForwardingBase {
  /**
...
export interface LambdaEfsMountProps {
  /**
...
export interface LambdaS3FilesMountProps {
  /**
