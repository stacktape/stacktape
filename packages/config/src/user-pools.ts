...
export type AllowedOauthFlow = 'code' | 'implicit' | 'client_credentials';


export type UserVerificationType = 'email-link' | 'email-code' | 'sms' | 'none';
...
export type StpAuthorizer = CognitoAuthorizer | LambdaAuthorizer;
