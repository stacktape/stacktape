import type { DomainConfiguration, EnvironmentVar, ResourceOverrides } from './shared';
import type { DirectoryUploadFilter, SupportedHeaderPreset } from './buckets';
import type { CdnRouteRewrite, EdgeFunctionsConfig } from './cdn';
/**
