...
export interface ManagedRuleGroupProps extends CommonRuleProps {
  /**
...
export interface CustomRuleGroupProps extends CommonRuleProps {
  /**
...
export interface RateBasedStatementProps extends CommonRuleProps {
  /**
