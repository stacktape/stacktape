...
import type { ApplicationLoadBalancerAlarm } from './alarms';
...
export interface LbRedirectProperties {
  /**
...
export interface ApplicationLoadBalancerCdnConfiguration extends CdnConfiguration {
  /**
