...
export interface ContainerWorkloadProps extends ResourceAccessProps {
  /**
...
export interface ContainerWorkloadContainerLogging extends LogForwardingBase {
  /**
...
export interface ContainerWorkloadContainerBase {
  /**
...
export interface ContainerWorkloadContainer extends ContainerWorkloadContainerBase {
  /**
...
export interface ContainerEfsMountProps {
  /**
