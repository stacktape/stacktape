import type { DevModeConfig, DomainConfiguration, ResourceOverrides } from './shared';
import type { ApplicationLoadBalancerAlarm, RelationalDatabaseAlarm } from './alarms';
import type { AbortIncompleteMultipartUpload, ClassTransition, Expiration, NonCurrentVersionClassTransition, NonCurrentVersionExpiration } from './buckets';
import type { ContainerWorkloadContainerLogging, ContainerWorkloadResourcesConfig } from './multi-container-workloads';
import type { AuroraEngine, AuroraServerlessV2Engine, DatabaseAccessibility, RdsEngine, RelationalDatabaseLogging } from './relational-databases';
/**
