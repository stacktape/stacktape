import type { ResourceOverrides, SimpleServiceContainer } from './shared';
import type { ApplicationLoadBalancer } from './application-load-balancers';
import type { ContainerWorkloadServiceConnectIntegration } from './events';
/**
...
export interface PrivateServiceProps extends SimpleServiceContainer {
  // /**
...
export interface PrivateServiceLoadBalancing {
  /**
   * ---
   *
   * **Example (YAML):**
