...
export type CapabilityProperties = {
  ...
  InstructionsDocuments?: CloudFormationValue<Array<CloudFormationValue<S3Location>>>;
  Name: CloudFormationValue<string>;
  Tags?: CloudFormationValue<Array<CloudFormationValue<CloudFormationTag>>>;
  Type: CloudFormationValue<"edi">;
};

export type CapabilityConfiguration = {
  Edi: CloudFormationValue<EdiConfiguration>;
};

export type EdiConfiguration = {
  CapabilityDirection?: CloudFormationValue<"INBOUND" | "OUTBOUND">;
  InputLocation: CloudFormationValue<S3Location>;
  OutputLocation: CloudFormationValue<S3Location>;
  TransformerId: CloudFormationValue<string>;
  Type: CloudFormationValue<EdiType>;
};
