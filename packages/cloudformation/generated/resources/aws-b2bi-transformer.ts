...
export type X12ElementRequirementValidationRule = {
  ElementPosition: CloudFormationValue<string>;
  Requirement: CloudFormationValue<"OPTIONAL" | "MANDATORY">;
};

export type X12SplitOptions = {
  SplitBy?: CloudFormationValue<"NONE" | "TRANSACTION">;
};

export type X12ValidationOptions = {
  ValidationRules?: CloudFormationValue<Array<CloudFormationValue<X12ValidationRule>>>;
};

export type X12ValidationRule = {
  CodeListValidationRule?: CloudFormationValue<X12CodeListValidationRule>;
  ElementLengthValidationRule?: CloudFormationValue<X12ElementLengthValidationRule>;
  ElementRequirementValidationRule?: CloudFormationValue<X12ElementRequirementValidationRule>;
};
