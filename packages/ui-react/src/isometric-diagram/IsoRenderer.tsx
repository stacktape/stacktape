...
// `@stacktape/ui-react/isometric-diagram.css`. They are referenced as variables rather than
 ...
 * scene or a configuration. `IsometricDiagram` extends this so the two stay one declaration.
 */
