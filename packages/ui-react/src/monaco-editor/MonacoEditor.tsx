import type { editor, MonacoEditor as MonacoNamespace } from 'monaco-types';
import type { CSSProperties, Ref } from 'react';
import type {
  CodeEditorOptions as MonacoEditorOptions,
  EditorSession,
...
export type {
  CodeEditorOptions as MonacoEditorOptions,
  EditorSessionCleanup as MonacoEditorCleanup,
  EditorSessionMountContext as MonacoEditorMountContext,
  ValueUpdateMode
} from './session.js';
...
const BASE_OPTIONS: MonacoEditorOptions = {
