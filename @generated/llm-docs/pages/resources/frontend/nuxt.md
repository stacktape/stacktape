...
### Definition: `NuxtWebProps`

The complete property-level reference is included in `llms-api-reference.txt` and indexed under route `/config-reference/nuxt-web` with definition name `NuxtWebProps`.
