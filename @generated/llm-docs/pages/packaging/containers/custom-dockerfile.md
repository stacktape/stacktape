...
> **Warning:** Do not pass secrets through `buildArgs`. They are visible in the image layer history. Use runtime environment variables or the Stacktape [`$Secret()` directive](/configuration/secrets) for sensitive values.
