...
2. **Build & package**: Packages Lambda functions and builds container images. Caches artifacts when possible.
3. **Upload**: Uploads packaged artifacts (zips, images) to S3 and ECR in your AWS account.
