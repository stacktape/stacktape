...
export class CustomDecodingInterface {
  Name!: Value<string>;
  constructor(properties: CustomDecodingInterface) {
    Object.assign(this, properties);
  }
}

export class CustomDecodingSignal {
  Id!: Value<string>;
  constructor(properties: CustomDecodingSignal) {
    Object.assign(this, properties);
  }
}
...
export interface DecoderManifestProperties {
  ...
  DefaultForUnmappedSignals?: Value<string>;
...
export default class DecoderManifest extends ResourceBase<DecoderManifestProperties> {
  ...
  static CustomDecodingInterface = CustomDecodingInterface;
  static CustomDecodingSignal = CustomDecodingSignal;
