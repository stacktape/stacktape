...
export class CompositeComponentType {
  ComponentTypeId?: Value<string>;
  constructor(properties: CompositeComponentType) {
...
export interface ComponentTypeProperties {
  ...
  CompositeComponentTypes?: { [key: string]: CompositeComponentType };
  Tags?: { [key: string]: Value<string> };
}
export default class ComponentType extends ResourceBase<ComponentTypeProperties> {
  static CompositeComponentType = CompositeComponentType;
