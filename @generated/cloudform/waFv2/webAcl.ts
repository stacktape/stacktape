...
export class AWSManagedRulesAntiDDoSRuleSet {
  ClientSideActionConfig!: ClientSideActionConfig;
  SensitivityToBlock?: Value<string>;
  constructor(properties: AWSManagedRulesAntiDDoSRuleSet) {
    Object.assign(this, properties);
  }
}
...
export class AsnMatchStatement {
  ...
  constructor(properties: AsnMatchStatement) {
    Object.assign(this, properties);
  }
}
...
export class ClientSideAction {
  UsageOfAction!: Value<string>;
  Sensitivity?: Value<string>;
  ExemptUriRegularExpressions?: List<Regex>;
  constructor(properties: ClientSideAction) {
    Object.assign(this, properties);
  }
}

export class ClientSideActionConfig {
  Challenge!: ClientSideAction;
  constructor(properties: ClientSideActionConfig) {
    Object.assign(this, properties);
  }
}
...
export class DataProtect {
  Field!: FieldToProtect;
  Action!: Value<string>;
  ExcludeRateBasedDetails?: Value<boolean>;
  ExcludeRuleMatchDetails?: Value<boolean>;
  constructor(properties: DataProtect) {
    Object.assign(this, properties);
  }
}

export class DataProtectionConfig {
  DataProtections!: List<DataProtect>;
  constructor(properties: DataProtectionConfig) {
    Object.assign(this, properties);
  }
}
...
export class FieldToProtect {
  FieldKeys?: List<Value<string>>;
  FieldType!: Value<string>;
  constructor(properties: FieldToProtect) {
    Object.assign(this, properties);
  }
}
...
export class JA3Fingerprint {
  FallbackBehavior!: Value<string>;
  constructor(properties: JA3Fingerprint) {
    Object.assign(this, properties);
  }
}

export class JA4Fingerprint {
  FallbackBehavior!: Value<string>;
  constructor(properties: JA4Fingerprint) {
    Object.assign(this, properties);
  }
}
...
export class OnSourceDDoSProtectionConfig {
  ALBLowReputationMode!: Value<string>;
  constructor(properties: OnSourceDDoSProtectionConfig) {
    Object.assign(this, properties);
  }
}
...
export class RateBasedStatement {
  ...
  ForwardedIPConfig?: ForwardedIPConfiguration;
  Limit!: Value<number>;
  EvaluationWindowSec?: Value<number>;
  ScopeDownStatement?: Statement;
...
export class RateLimitJA3Fingerprint {
  FallbackBehavior!: Value<string>;
  constructor(properties: RateLimitJA3Fingerprint) {
    Object.assign(this, properties);
  }
}

export class RateLimitJA4Fingerprint {
  FallbackBehavior!: Value<string>;
  constructor(properties: RateLimitJA4Fingerprint) {
    Object.assign(this, properties);
  }
}
...
export class UriFragment {
  FallbackBehavior?: Value<string>;
  constructor(properties: UriFragment) {
    Object.assign(this, properties);
  }
}
...
export default class WebACL extends ResourceBase<WebACLProperties> {
  ...
  static AWSManagedRulesAntiDDoSRuleSet = AWSManagedRulesAntiDDoSRuleSet;
  ...
  static ClientSideAction = ClientSideAction;
  static ClientSideActionConfig = ClientSideActionConfig;
  ...
  static DataProtect = DataProtect;
  static DataProtectionConfig = DataProtectionConfig;
  ...
  static FieldToProtect = FieldToProtect;
  ...
  static JA3Fingerprint = JA3Fingerprint;
  static JA4Fingerprint = JA4Fingerprint;
  ...
  static OnSourceDDoSProtectionConfig = OnSourceDDoSProtectionConfig;
  ...
  static RateLimitJA3Fingerprint = RateLimitJA3Fingerprint;
  static RateLimitJA4Fingerprint = RateLimitJA4Fingerprint;
  ...
  static UriFragment = UriFragment;
