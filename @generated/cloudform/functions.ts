...
export function GetAtt(cfLogicalNameOfResource: Value<string>, attributeName: Value<string>) {
  return new IntrinsicFunction('Fn::GetAtt', [cfLogicalNameOfResource, attributeName]);
}
...
export function Ref(cfLogicalName: Value<string>) {
  return new IntrinsicFunction('Ref', cfLogicalName);
}
