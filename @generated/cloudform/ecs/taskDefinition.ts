...
export class ContainerDefinition {
  ...
  CredentialSpecs?: List<Value<string>>;
  Ulimits?: List<Ulimit>;
  ...
  VersionConsistency?: Value<string>;
...
export class FSxAuthorizationConfig {
  CredentialsParameter!: Value<string>;
  Domain!: Value<string>;
  constructor(properties: FSxAuthorizationConfig) {
    Object.assign(this, properties);
  }
}

export class FSxWindowsFileServerVolumeConfiguration {
  AuthorizationConfig?: FSxAuthorizationConfig;
  FileSystemId!: Value<string>;
  RootDirectory!: Value<string>;
  constructor(properties: FSxWindowsFileServerVolumeConfiguration) {
    Object.assign(this, properties);
  }
}
...
export interface TaskDefinitionProperties {
  ...
  EnableFaultInjection?: Value<boolean>;
...
export default class TaskDefinition extends ResourceBase<TaskDefinitionProperties> {
  ...
  static FSxAuthorizationConfig = FSxAuthorizationConfig;
  static FSxWindowsFileServerVolumeConfiguration = FSxWindowsFileServerVolumeConfiguration;
