...
// Source: aws-ec2-natgateway.json

/**
 * Specifies a network address translation (NAT) gateway in the specified subnet. You can create
 * either a public NAT gateway or a private NAT gateway. The default is a public NAT gateway. If you
 * create a public NAT gateway, you must specify an elastic IP address.
 * With a NAT gateway, instances in a private subnet can connect to the internet, other AWS services,
 * or an on-premises network using the IP address of the NAT gateway. For more information, see [NAT
 ...
 * address](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-eips.html#allocate-eip) in the
 * *Amazon VPC User Guide*.
 */
export type AwsEc2Natgateway = {
  ...
  /**
   * The private IPv4 address to assign to the NAT gateway. If you don't provide an address, a private
   * IPv4 address will be automatically assigned.
   */
   ...
   * NAT gateway. This property is required for a public NAT gateway and cannot be specified with a
   * private NAT gateway.
   */
  AllocationId?: string;
  /**
   ...
   * NAT gateway. For more information about secondary addresses, see [Create a NAT
   * gateway](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html#nat-gateway-creating)
   * in the *Amazon Virtual Private Cloud User Guide*.
   * ``SecondaryPrivateIpAddressCount`` and ``SecondaryPrivateIpAddresses`` cannot be set at the same
   * time.
