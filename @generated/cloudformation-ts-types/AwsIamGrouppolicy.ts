...
// Source: aws-iam-grouppolicy.json
 ...
 * [IAM and quotas](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html) in the
 * *IAM User Guide*.
 */
export type AwsIamGrouppolicy = {
  /**
   * The policy document.
