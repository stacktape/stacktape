...
// Source: aws-proton-servicetemplate.json

/** Definition of AWS::Proton::ServiceTemplate Resource Type */
export type AwsProtonServicetemplate = {
  /**
  ...
  /**
   * <p>An optional list of metadata items that you can associate with the Proton service template. A
