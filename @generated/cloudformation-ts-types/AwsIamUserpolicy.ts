...
// Source: aws-iam-userpolicy.json
 ...
 * *IAM User Guide*.
 * For information about the maximum number of inline policies that you can embed in a user, see [IAM
 * and quotas](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html) in the *IAM
 * User Guide*.
 */
export type AwsIamUserpolicy = {
  /**
   * The policy document.
   * You must provide policies in JSON format in IAM. However, for CFN templates formatted in YAML, you
   * can provide the policy in JSON or YAML format. CFN always converts a YAML policy to JSON format
   * before submitting it to IAM.
   * The [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) used to validate
