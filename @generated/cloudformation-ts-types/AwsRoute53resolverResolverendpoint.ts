...
// Source: aws-route53resolver-resolverendpoint.json

/** Resource type definition for AWS::Route53Resolver::ResolverEndpoint */
export type AwsRoute53resolverResolverendpoint = {
  /**
   ...
   * - INBOUND_DELEGATION: allows DNS queries to your VPC from your network with authoritative answers
   * from private hosted zones
   */
  Direction: string;
   ...
   * or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a
   * VPC.
   * @uniqueItems false
   */
  IpAddresses: {
