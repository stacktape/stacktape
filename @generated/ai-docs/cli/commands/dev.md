...
<CliCommandsApiReference
  ...
  sortedArgs={[
    ...
    },
    {
      ...
      longDescription:
        "<p>Disables the automatic injection of parameters and credentials during local emulation. Use this flag if you want to run a compute resource locally that has not yet been deployed.</p>\n"
    },
    {
      description:
    ...
    },
    {
      ...
      longDescription:
        "<p>If <code>true</code>, watches for changes to your source files and automatically re-executes the compute resource when a change is detected.</p>\n"
    }
  ]}
/>