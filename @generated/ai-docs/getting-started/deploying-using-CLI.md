...
-   Start with a [starter project](../../getting-started/starter-project.md) that includes a pre-configured file.
-   Follow a tutorial like the [Fullstack Next.js T3 app](../../tutorials/t3-nextjs-app.md) or [Web API](../../tutorials/web-api.md).
