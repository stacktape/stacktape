...
If your repository doesn't have a `stacktape.yml` or `stacktape.ts` file, you can create one using the [interactive config editor](../../getting-started/using-config-editor.md).
