...
| Not implemented            | Floci integration, release publishing/cutover, full docs/website applications, and broader real-AWS canaries.                                                                                                                                                                                                                                                                                  |
| Release state              | The manual artifact-only candidate workflow is implemented and passed six-platform artifact assembly, npm-package validation, checksum generation, and an Alpine runtime smoke in [run 30511124729](https://github.com/stacktape/stacktape/actions/runs/30511124729). Publishing remains disabled. Repository default branches, production infrastructure, and customer rollout are unchanged. |
