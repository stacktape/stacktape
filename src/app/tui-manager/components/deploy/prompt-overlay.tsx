  ...
  return (
    <box flexDirection="column">
      ...
      <Show when={startIndex() > 0}>
        <text fg="#6b7280"> ^ {startIndex()} more above</text>
      </Show>
        ...
        {(opt, i) => {
          ...
          return (
            <box flexDirection="row">
              ...
              <Show when={isSelected()} fallback={<text fg="#d1d5db">{opt.label}</text>}>
                <text fg="#06b6d4">
                  <b>{opt.label}</b>
                </text>
              </Show>
              <Show when={opt.description}>
                <text fg="#6b7280"> {opt.description}</text>
              </Show>
            </box>
          );
        }}
      ...
      <Show when={startIndex() + maxVisible() < unique().uniqueOptions.length}>
        <text fg="#6b7280"> v {unique().uniqueOptions.length - startIndex() - maxVisible()} more below</text>
      </Show>
      <box height={1} />
    ...
    <box flexDirection="column">
      <box flexDirection="row">
        ...
        <Show when={props.prompt.description}>
          <text fg="#6b7280"> {props.prompt.description}</text>
        </Show>
      </box>
      <box flexDirection="row">
        <text fg="#06b6d4">{'> '}</text>
        ...
        <Show when={!value() && props.prompt.placeholder}>
          <text fg="#4b5563"> {props.prompt.placeholder}</text>
        </Show>
      </box>
      <box height={1} />
