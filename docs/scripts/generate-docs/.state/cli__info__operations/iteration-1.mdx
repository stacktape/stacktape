...
order: 179
seoTitle: 'info:operations CLI Command | Stacktape Docs'
seoDescription: 'View recent Stacktape deployment operations with status, timestamps, and errors. Filter by project, stage, or user to audit deploy and delete history across your organization.'
---
