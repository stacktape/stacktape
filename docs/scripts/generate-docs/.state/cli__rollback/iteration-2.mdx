...
seoDescription: 'Roll back a Stacktape deployment to a previous version without rebuilding. Reuses stored Lambda zips and container images, skipping the packaging step for fast recovery.'
---
...
<FlowDiagram steps={[
  ...
  { title: "Deployment", description: "CloudFormation applies the old template. Since artifacts already exist, no packaging or uploading occurs." },
