...
<Warning>
This command modifies your local AWS credentials and config files. The deleted profile will no longer be available to Stacktape or any other AWS tooling on your system.
</Warning>
