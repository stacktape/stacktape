...
title: 'Introduction'
order: 1
seoTitle: 'Stacktape Introduction — Deploy to AWS Without DevOps | Docs'
seoDescription: 'Stacktape deploys production-grade AWS infrastructure from a single config file. 30+ resource types, zero-config builds, built-in CI/CD — all in your own AWS account.'
---
