...
<Tip>Enable archiving for production event buses. The storage cost is low and the ability to replay events during an incident or when onboarding a new consumer is worth it.</Tip>
