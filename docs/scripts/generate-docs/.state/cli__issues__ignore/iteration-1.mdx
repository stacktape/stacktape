...
title: 'issues:ignore'
order: 185
seoTitle: 'issues:ignore CLI Command | Stacktape Docs'
seoDescription: 'Permanently silence a runtime issue with stacktape issues:ignore. Ignored issues won''t reopen on new occurrences or generate alerts. CLI reference and usage examples.'
---
