...
seoDescription: 'Manage AWS deployments, track costs, configure alarms and budgets, control team access, and enforce guardrails with the Stacktape Console.'
---
...
<Warning>
If a sidebar item is missing, your role may not include the required permission. Contact your organization's owner or admin to adjust your access. See [Team and access control](/stacktape-console/team-and-access-control) for role details.
</Warning>
