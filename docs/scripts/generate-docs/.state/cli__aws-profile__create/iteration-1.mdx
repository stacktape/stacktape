...
<Info>
If you need to manage AWS access through the Stacktape Console instead of local profiles, see [Connecting your AWS account](/stacktape-console/connecting-your-aws-account). Console-based access uses IAM roles rather than local credential files.
</Info>
