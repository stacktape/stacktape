...
title: 'login'
order: 171
seoTitle: 'stacktape login — Authenticate the Stacktape CLI | Docs'
seoDescription: 'Authenticate the Stacktape CLI with an API key or interactive sign-in. Set up login for local development, CI/CD pipelines, and AI agent workflows.'
---
