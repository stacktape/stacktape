...
The Stacktape Console is a web-based interface for deploying and managing your infrastructure. It complements the CLI with visual tools for deployments, monitoring, and team collaboration.

**Console URL:** [console.stacktape.com](https://console.stacktape.com)
...
<Warning>
  Don't delete the CloudFormation connection stack in AWS, or Stacktape will lose access to your account.
</Warning>
...
<NavBoxGrid columns={2}>
  <NavBox
    url="/configuration/typescript-config"
    text="Configuration Guide"
    description="Learn the configuration format"
  />
  <NavBox url="/deployment/gitops" text="GitOps Deployments" description="Set up automated deployments" />
</NavBoxGrid>
