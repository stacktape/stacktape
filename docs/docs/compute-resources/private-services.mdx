...
`embed:private-services/connecting.stp.yml`
...
`embed:private-services/env.stp.yml`
...
`embed:private-services/healthcheck.stp.yml`
...
<PropDescription definitionName="PrivateServiceProps" propertyName="resources" descType="ld" />
...
`embed:private-services/resources.stp.yml`
...
`embed:private-services/resources-ec2.stp.yml`
...
`embed:private-services/scaling.stp.yml`
...
`embed:private-services/allow-access-to.stp.yml`
...
`embed:private-services/iam-role-statements.stp.yml`
...
<PropDescription definitionName="PrivateServiceProps" propertyName="loadBalancing" descType="ld" />
...
<PropDescription definitionName="PrivateServiceProps" propertyName="port" descType="ld" />

`embed:private-services/alias-port.stp.yml`
