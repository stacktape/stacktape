...
seoDescription: 'Mark a runtime issue as ignored with stacktape issues:ignore. Ignored issues won''t reopen on new occurrences or generate alerts. CLI reference and usage examples.'
---
