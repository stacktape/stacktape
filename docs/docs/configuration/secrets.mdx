...
pipelineReviewSummary: 'reviewer-avg 8.1, hard blockers 1, advisory high 0, verifier medium 13'
---
...
<FeatureComparisonTable
  ...
  features={[
    ...
    { name: "JSON key extraction", values: { "$Secret()": true, "$SsmParam()": false } },
    ...
    { name: "Best for", values: { "$Secret()": "Passwords, API keys, tokens", "$SsmParam()": "Existing SSM parameters" } }
  ]}
/>
