...
`embed:web-services/basic-usage-stacktape-buildpack-image.stp.yml`
...
`embed:web-services/basic-usage-external-buildpack-image.stp.yml`
...
`embed:web-services/basic-usage-nixpacks-image.stp.yml`
...
`embed:web-services/basic-usage-dockerfile-image.stp.yml`
...
`embed:web-services/basic-usage-prebuilt-image.stp.yml`
