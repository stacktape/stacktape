...
pipelineReviewSummary: 'reviewer-avg 7.9, hard blockers 3, advisory high 0, verifier medium 8'
---
...
<Warning>When using an external queue, ensure the queue's resource policy grants your Lambda function's execution role the permissions needed to receive and delete messages. Stacktape handles this automatically for queues defined within the same stack using `sqsQueueName`.</Warning>
