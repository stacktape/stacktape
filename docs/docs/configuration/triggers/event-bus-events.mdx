...
seoDescription: 'Trigger Lambda functions and batch jobs from EventBridge events. Configure pattern-based routing, payload transformation, and dead-letter queues in Stacktape.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 8.2, hard blockers 3, advisory high 0, verifier medium 13'
---
