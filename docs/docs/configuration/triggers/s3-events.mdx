...
title: 'S3 Events'
order: 21
seoTitle: 'S3 Event Triggers for Lambda and Batch Jobs | Stacktape'
seoDescription: 'Trigger Lambda functions or batch jobs when objects are uploaded, deleted, or restored in S3 buckets. Configure event types, key prefix and suffix filters, and handle payloads with Stacktape.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 7.9, hard blockers 4, advisory high 0, verifier medium 10'
---
