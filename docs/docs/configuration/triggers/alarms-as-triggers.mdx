...
pipelineReviewSummary: 'reviewer-avg 7.5, hard blockers 5, advisory high 1, verifier medium 12'
---
...
<Tip>Design your handler to be idempotent. The underlying AWS infrastructure may deliver the same alarm event more than once, so your code should safely handle duplicate invocations without producing duplicate side effects.</Tip>
