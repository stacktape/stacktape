...
seoDescription: 'Run Lambda functions on cron or rate schedules with Stacktape. Configure recurring tasks using AWS EventBridge rules, customize event payloads, and monitor scheduled invocations.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 8.5, hard blockers 2, advisory high 0, verifier medium 5'
---
