...
<Tip>
Task states reference Lambda functions by their CloudFormation logical names. Inspect the compiled template (via [`stacktape synth`](/cli/synth)) to verify logical names before hard-coding them. The logical names used in examples on this page are illustrative.
</Tip>
...
<Tip>
Use [`stacktape synth`](/cli/synth) to inspect the CloudFormation resources generated for the state machine before applying overrides.
</Tip>
