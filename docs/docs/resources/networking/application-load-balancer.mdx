...
<FeatureComparisonTable
  ...
  features={[
    { name: "Pricing model", values: { "Application Load Balancer": "Flat ~$18/month + LCU-based", "HTTP API Gateway": "Pay-per-request" } },
    { name: "Best for", values: { "Application Load Balancer": "Container workloads", "HTTP API Gateway": "Lambda functions" } },
    { name: "Scales to zero cost", values: { "Application Load Balancer": "No", "HTTP API Gateway": "Yes" } },
    ...
    { name: "WebSocket support", values: { "Application Load Balancer": "Yes", "HTTP API Gateway": "No" } },
    { name: "Direct WAF attachment", values: { "Application Load Balancer": "Yes", "HTTP API Gateway": "No" } },
    { name: "Gradual deployments", values: { "Application Load Balancer": "Yes", "HTTP API Gateway": "No" } },
    { name: "CDN attachable", values: { "Application Load Balancer": "Yes", "HTTP API Gateway": "Yes" } }
  ]}
/>
