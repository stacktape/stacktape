...
pipelineReviewSummary: 'reviewer-avg 7.9, hard blockers 1, advisory high 0, verifier medium 5'
---
...
Custom domains attach directly to the four public networking resources Stacktape exposes:
...
To put a custom domain in front of a compute workload, frontend, or static site, route traffic through one of these networking resources — for example, place a [CDN](/resources/networking/cdn) in front of a static site or SSR frontend, or front a containerized [web service](/resources/compute/web-service) with an [Application Load Balancer](/resources/networking/application-load-balancer).
