...
order: 74
seoTitle: 'AgentCore Browser - Sandboxed Browser for AI Agents | Stacktape Docs'
seoDescription: 'Add a managed sandboxed browser to your AWS Bedrock AgentCore agents with Stacktape. Configure recording and attach to runtimes via useBrowser.'
---
...
<Tip>Add recording selectively when you need stored browser sessions for review. Confirm any audit or retention requirements in your own S3 bucket configuration.</Tip>
  ...
  tabs={[
    {
      label: 'TypeScript',
      lang: 'typescript',
      code: `import { defineConfig, AgentCoreBrowser, Bucket } from 'stacktape';
...
<ApiReference definitionName="AgentCoreBrowserProps" />
