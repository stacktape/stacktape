...
seoDescription: 'Deploy serverless DynamoDB tables on AWS with Stacktape. On-demand or provisioned capacity, secondary indexes, streams, auto-scaling, and zero-config local dev mode.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 8.0, hard blockers 2, advisory high 0, verifier medium 3'
---
