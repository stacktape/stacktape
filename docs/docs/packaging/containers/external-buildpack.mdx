...
seoDescription: 'Build container images with Cloud Native Buildpacks in Stacktape. Auto-detect language, zero Dockerfile needed. Supports Paketo, Heroku, and Google builders.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 7.4, hard blockers 0, advisory high 0, verifier medium 0'
---
