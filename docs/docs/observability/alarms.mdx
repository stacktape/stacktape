...
seoDescription: 'Configure CloudWatch alarms for Lambda functions, databases, API gateways, load balancers, and SQS queues. Set thresholds, evaluation windows, and Slack/email/webhook notifications.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 7.4, hard blockers 7, advisory high 1, verifier medium 13'
---
...
<ApiReference definitionName="AlarmDefinitionBase" />
