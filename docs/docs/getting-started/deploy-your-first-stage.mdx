...
seoDescription: 'Deploy your first Stacktape stage to AWS. Log in, connect your AWS account with one command, and run stacktape deploy to provision real infrastructure from your TypeScript config.'
pipelineStatus: 'needs-human-review'
pipelineReviewSummary: 'reviewer-avg 7.8, hard blockers 6, advisory high 0, verifier medium 3'
---
