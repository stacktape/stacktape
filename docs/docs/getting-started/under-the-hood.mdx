...
<PreviousNext
  left={{ url: "/getting-started/using-config-editor/", title: "Using the Config Editor" }}
  right={{ url: "/getting-started/deploying-using-console/", title: "Deploying with the Console" }}
/>
