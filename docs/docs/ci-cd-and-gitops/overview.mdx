...
<FeatureComparisonTable
  columns={["GitOps (Console)", "deploy --runner codebuild (CLI)", "Custom CI/CD", "Self-hosted GitHub Actions runners"]}
  features={[
    { name: "Setup effort", values: { "GitOps (Console)": "Configure in Console — no pipeline files", "deploy --runner codebuild (CLI)": "Single CLI command — no pipeline files", "Custom CI/CD": "Write a workflow or pipeline file", "Self-hosted GitHub Actions runners": "Enable in Console + write a GitHub Actions workflow" } },
    { name: "Where the build runs", values: { "GitOps (Console)": "AWS CodeBuild or EC2 runner (Console-managed)", "deploy --runner codebuild (CLI)": "AWS CodeBuild", "Custom CI/CD": "Your CI provider's runners", "Self-hosted GitHub Actions runners": "EC2 instances in your AWS account" } },
    { name: "Pipeline customization", values: { "GitOps (Console)": "Maps git events directly to deployments", "deploy --runner codebuild (CLI)": "None — runs a single deployment", "Custom CI/CD": "Full control — tests, lint, approval gates, multi-step builds", "Self-hosted GitHub Actions runners": "Full GitHub Actions flexibility" } },
    { name: "Maintenance", values: { "GitOps (Console)": "Managed by Stacktape", "deploy --runner codebuild (CLI)": "None — on-demand command", "Custom CI/CD": "You own the pipeline definition", "Self-hosted GitHub Actions runners": "You own the workflow" } },
    { name: "PR previews", values: { "GitOps (Console)": "Configuration displays stage as pr-{#number}", "deploy --runner codebuild (CLI)": "Manual — pass stage name as argument", "Custom CI/CD": "Manual setup with dynamic stage names", "Self-hosted GitHub Actions runners": "Manual setup with dynamic stage names" } },
  ]}
/>
