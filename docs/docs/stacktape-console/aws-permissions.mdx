...
<Info>If a connected AWS account is referenced by GitOps deployment configurations, the Console blocks deletion and lists the projects whose GitOps configurations must be removed first.</Info>
